    ...
    public partial class fMain : Form
    {
       ...
       //dataGridViewVTPTPhieuSuaChua.Columns["Mã phụ tùng"].Visible = false;
        ...
        private void fMain_Load(object sender, EventArgs e)
        {
            ...
            //dataGridViewPSCHienCo.DataSource = PhieuSuaChuaBUS.Instance.HienThiThongTinPhieuSuachua(comboBoxBienSoXe1.Text);
            // Điển ngày thu tiền
        ...
        private void btnTaoMoiPCS_Click(object sender, EventArgs e)
        {
            ...
            KhoiTaoDataGridviewVTPT();
            KhoiTaoDataGridviewTienCong();
            KhoiTaoDataGridviewPSCHienCo(comboBoxBienSoXe1.Text);
        ...
        private void buttonLapPhieuThuTienPTT_Click(object sender, EventArgs e)
        {
            if (textBoxSoTienThuPTT.Text != "")
            {
                if (PhieuThuTienBUS.Instance.LayTienNoKH(comboBienSoXe2.Text) < int.Parse(textBoxSoTienThuPTT.Text))
                    MessageBox.Show("Số tiền thu vượt quá số tiền nợ! Nhập lại");
                else
                {
                    int test = 0;
        ...
        private void comboBienSoXe2_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            int info2 = PhieuThuTienBUS.Instance.LayTienNoKH(comboBienSoXe2.Text);
            textBoxTienNoPTT.Text = info2.ToString();
        }
        ...
        private void LamMoi_comBoxHieuXe()
        {
            DataTable tbl_tenHX = new DataTable();
            tbl_tenHX = DataProvider.Instance.ExecuteQuery("SELECT TenHieuXe FROM HIEUXE");
            comBoxHieuXe.DataSource = tbl_tenHX;
            comBoxHieuXe.DisplayMember = "TenHieuXe";
            comBoxHieuXe.ValueMember = "TenHieuXe";
        }

        private void LamMoi_comboBoxHieuXeTraCuu()
        {
            DataTable tbl_tenHX = new DataTable();
            tbl_tenHX = DataProvider.Instance.ExecuteQuery("SELECT TenHieuXe FROM HIEUXE");
            comboBoxHieuXeTraCuu.DataSource = tbl_tenHX;
            comboBoxHieuXeTraCuu.DisplayMember = "TenHieuXe";
            comboBoxHieuXeTraCuu.ValueMember = "TenHieuXe";
        }

        private void LamMoi_TienNoPTT()
        {
            int info2 = PhieuThuTienBUS.Instance.LayTienNoKH(comboBienSoXe2.Text);
            textBoxTienNoPTT.Text = info2.ToString();
        ...
        private void lblThangBaoCaoTon_Click(object sender, EventArgs e)
        {

        }

        private void tabPageLapPhieuSuachua_Click(object sender, EventArgs e)
        {
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            //try
            //{
              //  this.xETableAdapter.FillBy(this.quanLyGarageDataSet.XE);
            //}
        ...
        private void labelSoLuongXeCuaNgay_Click(object sender, EventArgs e)
        {

        }

        private void comboBienSoXe2_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void comboBoxTenTC_SelectionChangeCommitted(object sender, EventArgs e)
        {
